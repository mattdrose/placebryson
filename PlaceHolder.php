 ...
 * are required.
 *
 * Source: <https://github.com/seyDoggy/placeholder>
 *
...
class PlaceHolder extends \claviska\SimpleImage
{
    ...
    private function createPlaceHolderImage($width, $height)
    {
        try {
            /**
             * uses the fromFile method from claviska\SimpleImage()
             */
            $this->fromFile($this->getRandomImage());

            /**
             * set some garbage variables for ratio comparisons
             */
            $getRatio = $this->getWidth()/$this->getHeight();
            $ratio = $width/$height;
            ...
            if ($this->effect != null) {
                ...
                /**
                 * apply claviska\SimpleImage() manipulations
                 */
                switch ($this->effect) {
                case 'bw':
                    $this->desaturate();
            ...
            /**
             * output the final result using claviska\SimpleImage() toScreen method
             */
            $this->toScreen();
